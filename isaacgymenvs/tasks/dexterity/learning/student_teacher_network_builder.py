...
class StudentTeacherA2CBuilder(A2CBuilder):
    def build(self, name, **kwargs):
        self.go_architecture = 'skip_connection'
        ...
        if self.method == 'guided_observations':
        ...
        net = StudentTeacherA2CBuilder.Network(self.params, **kwargs)
        ...
        net.go_architecture = self.go_architecture
